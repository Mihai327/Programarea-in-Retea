...
public class GetRequestToUtmMd {
    ...
    private static void getImages(String imgName) {
        try {
            ...
            OutputStream dos = new FileOutputStream("X:\\Universitate\\Anul 3\\Semestrul_ll\\Programarea_In_Retea\\Laboratoare\\Lab_1\\imagesUtmMd\\" + tokens[tokens.length - 1]);
